...
# TODO: needed? Why does //examples/worker not do this?
def rollup_bundle_macro(tags = [], **kwargs):
    tags = tags + [
        # Tell ibazel not to restart rollup when its deps change.
        "ibazel_notify_changes",

        # Tell ibazel to serve the live reload script, since we expect a browser will connect to this program.
        "ibazel_live_reload",
    ]

    rollup_bundle(tags = tags, **kwargs)
