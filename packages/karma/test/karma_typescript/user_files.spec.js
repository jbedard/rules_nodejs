...
describe('karma_web_test_suite', () => {
  ...
  it('should only collect node_sources and dev_scripts in user files', () => {
    ...
    expect(files).toEqual([
      ...
      'build_bazel_rules_nodejs/packages/karma/test/karma_typescript/subdirindex.spec.js',
      'build_bazel_rules_nodejs/packages/karma/test/karma_typescript/decrement.js',
      'build_bazel_rules_nodejs/packages/karma/test/karma_typescript/subdirindex/index.js',
      'build_bazel_rules_nodejs/packages/karma/test/karma_typescript/subdirindex/lib.js',
